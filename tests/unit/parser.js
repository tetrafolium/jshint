...
exports.peekOverDirectives = function (test) {
  var code = fs.readFileSync(
    __dirname + "/fixtures/peek-over-directives.js",
    "utf8"
  );
  ...
  TestRun(test)
    ...
    .addError(
      22,
      14,
      "'Octal integer literal' is only available in ES6 (use 'esversion: 6')."
    )
    .addError(
      23,
      14,
      "'Binary integer literal' is only available in ES6 (use 'esversion: 6')."
    )
    .addError(
      24,
      14,
    ...
    .addError(
      25,
      14,
      "'Sticky RegExp flag' is only available in ES6 (use 'esversion: 6')."
    )
...
exports.confusingOps = function (test) {
  ...
  TestRun(test, "UnaryExpressions")
    ...
    .test(["void - -x;", "void - --x;", "void + +x;", "void + ++x;"]);
...
exports.assignment = function (test) {
  ...
  TestRun(test, "assignment to `eval` outside of strict mode code").test([
    "(function() {",
    "  var eval = 3;",
    "}());",
  ]);
...
exports.options = function (test) {
  ...
  var run = TestRun(test)
    ...
    .addError(
      7,
      1,
      "Expected a small integer or 'false' and instead saw '100.4'."
    )
    .addError(
      8,
      1,
      "Expected a small integer or 'false' and instead saw '200.4'."
    )
    .addError(
      9,
      1,
      "Expected a small integer or 'false' and instead saw '300.4'."
    )
...
exports[
  "jshint option comments single line, leading and trailing space"
] = function (test) {
...
exports[
  "jshint option comments multi line, leading and trailing space"
] = function (test) {
...
exports[
  "jshint option comments multi line/option, leading and trailing space"
] = function (test) {
...
exports[
  "jshint option inline comments, leading and trailing tabs and spaces"
] = function (test) {
  var src = fs.readFileSync(
    __dirname + "/fixtures/inline-tabs-spaces.js",
    "utf8"
  );
...
exports.numbers = function (test) {
  ...
  TestRun(test)
    ...
    .addError(
      5,
      11,
      "A leading decimal point can be confused with a dot: '.3'."
    )
  ...
  TestRun(test)
    ...
    .test(["(function () {", "'use strict';", "return 045;", "}());"]);
...
exports.comments = function (test) {
  ...
  TestRun(test).test(src);
  TestRun(test).test(
    fs.readFileSync(__dirname + "/fixtures/gruntComment.js", "utf8")
  );
...
exports.regexp.basic = function (test) {
  ...
  TestRun(test)
    .addError(
      1,
      12,
      "A trailing decimal point can be confused with a dot: '10.'."
    )
  ...
  TestRun(
    test,
    "Invalid Decimal Escape Sequence tolerated without `u` flag"
  ).test([
    "void /\\00/;",
    "void /\\01/;",
    "void /\\02/;",
...
exports.regexp.uFlag = function (test) {
  ...
  TestRun(test)
    .addError(
      1,
      9,
      "'Unicode RegExp flag' is only available in ES6 (use 'esversion: 6')."
    )
    .test("var a = /.*/u;");
  ...
  TestRun(test)
    ...
    .test(
      ["var a = /\\u{0}/u;", "a = /\\u{10FFFF}/u;", "a = /\\u{110000}/u;"],
      { esnext: true }
    );

  TestRun(
    test,
    "Guard against regression from escape sequence substitution"
  ...
  TestRun(test, "Valid group reference - multiple digits").test(
    [
      "void /(.)(.)(.)(.)(.)(.)(.)(.)(.)(.)\\10/u;",
      "void /(.)(.)(.)(.)(.)(.)(.)(.)(.)(.)\\10a/u;",
      "void /(.)(.)(.)(.)(.)(.)(.)(.)(.)(.)(.)\\11/u;",
  ...
  TestRun(
    test,
    "Invalid group reference (permitted without flag)"
  ...
  TestRun(
    test,
    "Invalid unicode escape sequence (permitted without flag)"
  ...
  TestRun(
    test,
    "Invalid character escape (permitted without flag)"
  ...
  TestRun(
    test,
    "Invalid quantifed group (permitted without flag)"
  ...
  TestRun(
    test,
    "Invalid quantifier - unclosed (permitted without flag)"
  ...
  TestRun(
    test,
    "Invalid quantifier - unclosed with comma (permitted without flag)"
  ).test("void /.{1,/;", { esversion: 6 });
  ...
  TestRun(
    test,
    "Invalid quantifier - unclosed with upper bound (permitted without flag)"
  ).test("void /.{1,2/;", { esversion: 6 });

  TestRun(
    test,
    "Character class in lower bound of range (permitted without flag)"
  ...
  TestRun(
    test,
    "Character class in upper bound of range (permitted without flag)"
  ...
  TestRun(test, "Null CharacterEscape").test(
    ["void /\\0/u;", "void /\\0a/u;"],
    { esversion: 6 }
  );
  ...
  TestRun(test, "ControlEscape").test(
    [
      "void /\\f/u;",
      "void /\\n/u;",
      "void /\\r/u;",
...
exports.regexp.dotAll = function (test) {
  TestRun(test, "flag presence - disallowed in editions prior to 2018")
    .addError(
      1,
      6,
      "'DotAll RegExp flag' is only available in ES9 (use 'esversion: 9')."
    )
    .addError(
      2,
      6,
    ...
    .test(["void /./s;", "void /./gs;", "void /./sg;"], { esversion: 8 });

  TestRun(test, "flag presence - allowed in 2018").test(
    ["void /./s;", "void /./gs;", "void /./sg;"],
    { esversion: 9 }
  );
  ...
  TestRun(test, "duplicate flag")
    ...
    .test(["void /./ss;", "void /./sgs;"], { esversion: 9 });
  ...
  TestRun(test, "dot following escape").test(
    [
      "void /RegExp dot \\\\./s;",
      "void /\\\\. RegExp dot/s;",
      "void /RegExp dot \\\\\\\\./s;",
...
exports.regexpSticky = function (test) {
  ...
  TestRun(test, "Invalid due to repetition")
    ...
    .test(["var exp = /./yy;", "var exp = /./ygy;"], { esversion: 6 });

  TestRun(test, "Invalid due to other conditions")
    .addError(1, 11, "Invalid regular expression.")
    .addError(2, 11, "Invalid regular expression.")
    .test(["var exp = /./gyg;", "var exp = /?/y;"], { esversion: 6 });
...
exports.json.errors = function (test) {
  ...
  var run12 = TestRun(test).addError(
    1,
    3,
    "Expected a string and instead saw k1."
  );
...
exports.comma = function (test) {
  ...
  TestRun(test)
    ...
    .test(["var a;", "while(true) {", "  a=1, break;", "}"], {});
...
exports["gh-2587"] = function (test) {
  TestRun(test)
    ...
    .addError(1, 8, "Expected '===' and instead saw '=='.")
    .test(["true == if"], { eqeqeq: true, eqnull: true });
...
exports.functionCharacterLocation = function (test) {
  ...
  var locations = JSON.parse(
    fs.readFileSync(
      __dirname + "/fixtures/nestedFunctions-locations.js",
      "utf8"
    )
  );
  JSHINT(src);
...
exports.exported = function (test) {
  ...
  TestRun(test)
    ...
    .test("var unused = 1; var used = 2;", {
      exported: ["used"],
      unused: true,
    });

  TestRun(test, "exported vars aren't used before definition").test("var a;", {
    exported: ["a"],
    latedef: true,
  });
...
exports["destructuring var errors"] = function (test) {
  ...
  TestRun(test)
    ...
    .addError(
      11,
      25,
      "Expected ']' to match '[' from line 11 and instead saw ';'."
    )
...
exports[
  "destructuring assignment of valid simple assignment targets"
] = function (test) {
  TestRun(test).test(
    [
      "[ foo().attr ] = [];",
...
exports["let block and let expression as esnext"] = function (test) {
  ...
  TestRun(test)
    ...
    .addError(
      6,
      22,
      "Expected ')' to match '(' from line 6 and instead saw 'x'."
    )
...
exports[
  "make sure let variables in the closure of functions shadow predefined globals"
] = function (test) {
  var code = [
    "function x() {",
    "  let foo;",
...
exports[
  "make sure let variables in the closure of blocks shadow predefined globals"
] = function (test) {
  var code = [
    "function x() {",
    "  let foo;",
...
exports[
  "make sure variables may shadow globals in functions after they are referenced"
] = function (test) {
...
exports[
  "test block scope redefines globals only outside of blocks"
] = function (test) {
...
exports["non-simple parameter list strict transition"] = function (test) {
  ...
  TestRun(
    test,
    "no transition: ES6 & non-strict mode"
  ).test(noTransitionNonStrict, { esversion: 6 });
  TestRun(
    test,
    "no transition: ES7 & non-strict mode"
  ...
  TestRun(test, "direct transition: ES6").test(directTransition, {
    esversion: 6,
  });
  ...
  TestRun(test, "indirect transition: ES6").test(indirectTransition, {
    esversion: 6,
  });
  TestRun(test, "indirect transition: ES7").test(indirectTransition, {
    esversion: 7,
  });
...
exports["invalid for each as esnext"] = function (test) {
  ...
  TestRun(test)
    ...
    .addError(
      1,
      5,
      "'for each' is only available in Mozilla JavaScript extensions (use moz option)."
    )
    .test(code, { esnext: true, unused: true, undef: true, predef: ["print"] });
...
exports["esnext generator as moz extension"] = function (test) {
  ...
  TestRun(test)
    .addError(
      1,
      9,
      "'function*' is only available in ES6 (use 'esversion: 6')."
    )
    .test(code, { moz: true, unused: true, undef: true, predef: ["print"] });
...
exports.optionalCatch = function (test) {
  ...
  TestRun(test)
    .addError(
      1,
      8,
      "'optional catch binding' is only available in ES10 (use 'esversion: 10')."
    )
    .test(code);

  TestRun(test).test(code, { esversion: 10 });
...
exports["strict violation - use of arguments and eval"] = function (test) {
  ...
  TestRun(test, "via `catch` clause binding (valid)").test([
    "try {} catch (arguments) {}",
    "try {} catch (eval) {}",
  ]);
  ...
  TestRun(test, "via parameter (valid)").test([
  ...
  TestRun(test, "as function binding (valid)").test([
    "function arguments() {}",
    "function eval() {}",
  ...
  TestRun(
    test,
    "as function bindings for expressions with inferred names (valid)"
  ).test([
...
exports[
  "moz-style array comprehension with dest array at global scope"
] = function (test) {
  var code = [
...
exports[
  "moz-style array comprehension with dest array at global scope as esnext"
] = function (test) {
  var code = [
    "[ [i, j] for each ([i, j] in [[0,0], [1,1], [2,2]])];",
    "var destarray_comparray_1 = [ [i, [j, j] ] for each ([i, j] in [[0,0], [1,1], [2,2]])];",
...
exports[
  "array comprehension with dest array at global scope as es5"
] = function (test) {
  var code = [
    "[for ([i, j] of [[0,0], [1,1], [2,2]]) [i, j] ];",
    "var destarray_comparray_1 = [for ([i, j] of [[0,0], [1,1], [2,2]]) [i, [j, j] ] ];",
...
exports[
  "moz-style array comprehension with dest array at global scope as es5"
] = function (test) {
  var code = [
    "[ [i, j] for each ([i, j] in [[0,0], [1,1], [2,2]])];",
    "var destarray_comparray_1 = [ [i, [j, j] ] for each ([i, j] in [[0,0], [1,1], [2,2]])];",
...
exports[
  "array comprehension with dest array at global scope as JS legacy"
] = function (test) {
  var code = [
    "[for ([i, j] of [[0,0], [1,1], [2,2]]) [i, j] ];",
    "var destarray_comparray_1 = [for ([i, j] of [[0,0], [1,1], [2,2]]) [i, [j, j] ] ];",
...
exports[
  "moz-style array comprehension with dest array at global scope as JS legacy"
] = function (test) {
  var code = [
    "[ [i, j] for each ([i, j] in [[0,0], [1,1], [2,2]])];",
    "var destarray_comparray_1 = [ [i, [j, j] ] for each ([i, j] in [[0,0], [1,1], [2,2]])];",
...
exports[
  "moz-style array comprehension imbrication with dest array"
] = function (test) {
  var code = [
...
exports[
  "moz-style array comprehension imbrication with dest array using for..of"
] = function (test) {
  var code = [
...
exports[
  "moz-style array comprehension imbrication with dest array as esnext"
] = function (test) {
  var code = [
...
exports[
  "moz-style array comprehension imbrication with dest array as es5"
] = function (test) {
  var code = [
    "[for ([i, j] of [for ([a, b] of [[2,2], [3,4]]) [a, b] ]) [i, j] ];",
  ];
...
exports[
  "array comprehension imbrication with dest array as legacy JS"
] = function (test) {
  var code = [
    "[ [i, j] for each ([i, j] in [[a, b] for each ([a, b] in [[2,2], [3,4]])]) ];",
  ];
...
exports[
  "moz-style array comprehension imbrication with dest array as legacy JS"
] = function (test) {
  var code = [
    "[ [i, j] for each ([i, j] in [[a, b] for each ([a, b] in [[2,2], [3,4]])]) ];",
  ];
...
exports["try catch filters as esnext"] = function (test) {
  ...
  TestRun(test)
    .addError(
      4,
      8,
      "'catch filter' is only available in Mozilla JavaScript extensions " +
        "(use moz option)."
    )
    .test(code, { esnext: true, undef: true, predef: ["print"] });
...
exports["for of as esnext"] = function (test) {
  ...
  TestRun(test)
    .addError(
      7,
      9,
      "Invalid for-of loop left-hand-side: initializer is forbidden."
    )
    .addError(
      8,
      8,
      "Invalid for-of loop left-hand-side: more than one ForBinding."
    )
    .addError(
      9,
      17,
  ...
  TestRun(test, "Left-hand side as MemberExpression").test(
    ["for (x.y of []) {}", "for (x[z] of []) {}"],
    { esversion: 2015 }
  );
  ...
  TestRun(test, "Left-hand side as MemberExpression (invalid)")
    ...
    .test(["for (x+y of {}) {}", "for ((this) of {}) {}"], { esversion: 2015 });

  TestRun(test, "let binding named `of`").test("for (let of of []) {}", {
    esversion: 2015,
  });
...
exports["array destructuring for of as esnext"] = function (test) {
  ...
  TestRun(test, "basic")
    ...
    .addError(
      1,
      10,
      "Creating global 'for' variable. Should be 'for (var v ...'."
    )
...
exports["object destructuring for of as esnext"] = function (test) {
  ...
  TestRun(test, "basic")
    .addError(
      4,
      7,
      "Creating global 'for' variable. Should be 'for (var key ...'."
    )
    .addError(
      4,
      20,
      "Creating global 'for' variable. Should be 'for (var value ...'."
    )
    .test(basic, { esnext: true, undef: true, predef: ["print"] });
...
exports["try multi-catch as esnext"] = function (test) {
  ...
  TestRun(test)
    .addError(
      5,
      3,
      "'multiple catch blocks' is only available in Mozilla JavaScript extensions " +
        "(use moz option)."
    )
    .test(code, { esnext: true, undef: true, predef: ["print"] });
...
exports["no let not directly within a block"] = function (test) {
  ...
  TestRun(test).test("if (true) let (x = 1) print(x);", {
    moz: true,
    predef: ["print"],
  });
...
exports["default arguments in fat arrow functions"] = function (test) {
  TestRun(test).test("(x = 0) => { return x; };", {
    expr: true,
    unused: true,
    esnext: true,
  });
...
exports["arrow function parameter containing semicolon (gh-3002)"] = function (
  test
) {
  TestRun(test)
...
exports["object ComputedPropertyName"] = function (test) {
  ...
  TestRun(test, "regression test for gh-3381").test(
    ["void {", "  set() {}", "};"],
    { esversion: 6 }
  );
  ...
  TestRun(test, "YieldExpression").test(
    [
      "(function * () {",
      "  void {",
      "    [yield]: 0,",
...
exports.classes = function (test) {
  ...
  var run = TestRun(test)
    .addError(
      cdecl + 3,
      7,
      "Expected an identifier and instead saw 'protected' (a reserved word)."
    )
    .addError(
      cexpr + 3,
      20,
    ...
    .addError(
      cdecl + 6,
      20,
      "Expected an identifier and instead saw 'interface' (a reserved word)."
    )
    .addError(
      cexpr + 6,
      27,
...
exports["class and method naming"] = function (test) {
  ...
  var run = TestRun(test)
    ...
    .addError(
      7,
      6,
      "Class properties must be methods. Expected '(' but instead saw 'extra'."
    )
    .addError(
      8,
      11,
      "Class properties must be methods. Expected '(' but instead saw 'extraIdent1'."
    )
    .addError(
      9,
      11,
      "Class properties must be methods. Expected '(' but instead saw 'extraIdent2'."
    )
    .addError(
      10,
      15,
      "Class properties must be methods. Expected '(' but instead saw 'extraIdent3'."
    )
    .addError(
      11,
      17,
      "Class properties must be methods. Expected '(' but instead saw 'extraIdent4'."
    )
    .addError(
      12,
      17,
      "Class properties must be methods. Expected '(' but instead saw 'extraIdent5'."
    )
  ...
  TestRun(test, "valid uses of name `constructor`").test(
    [
      "void class {",
      "  constructor() {}",
      "};",
  ...
  TestRun(test, "valid uses of name `prototype`").test(
    [
      "void class {",
      "  get prototype() {}",
      "};",
  ...
  TestRun(test, "valid uses of name `static`").test(
    [
      "void class {",
      "  static() {}",
      "  static static() {}",
  ...
  TestRun(test, "invalid use of name `prototype`: static method")
    ...
    .test(["void class {", "  static prototype() {}", "};"], { esversion: 6 });

  TestRun(test, "invalid use of name `prototype`: static accessor method")
    .addError(
      2,
      14,
      "A static class getter method cannot be named 'prototype'."
    )
    .test(["void class {", "  static get prototype() {}", "};"], {
      esversion: 6,
    });
  ...
  TestRun(test, "hazardous method names -- true duplicate (see gh-3358)")
    ...
    .test(
      ["void class {", "  toString() {}", "  x() {}", "  toString() {}", "};"],
      { esversion: 6 }
    );
  ...
  TestRun(
    test,
    "hazardous accessor method names -- true duplicate (see gh-3358)"
  )
...
exports.classNewcap = function (test) {
  ...
  TestRun(
    test,
    "The `newcap` option is not automatically enabled within class bodies."
  ).test(code, { esversion: 6 });
...
exports.super.superProperty = function (test) {
  ...
  TestRun(test, "within arrow functions").test(
    [
      "void {",
      "  m() {",
      "    void (() => {",
...
exports.functionReassignment = function (test) {
  ...
  TestRun(test, "generator functions")
    ...
    .test(["function * g () { yield; }", "g = null;"], { esversion: 6 });
  ...
  TestRun(test, "async functions")
    ...
    .test(["async function a () {}", "a = null;"], { esversion: 8 });
...
exports.invalidClasses = function (test) {
  ...
  TestRun(test)
    ...
    .test(["class Test {", "  constructor: {", "  }", "}"], { esnext: true });
...
exports["test for GH-1105"] = function (test) {
  ...
  TestRun(test).addError(2, 22, "Missing semicolon.").test(code);

  code = ["while (true) {", "    if (true) { continue }", "}"];

  TestRun(test).addError(2, 25, "Missing semicolon.").test(code);
...
exports["test for crash with invalid condition"] = function (test) {
  ...
  var run = TestRun(test)
    ...
    .addError(
      4,
      15,
      "Expected ')' to match '(' from line 4 and instead saw 'b'."
    )
    ...
    .addError(
      8,
      16,
      "Expected ')' to match '(' from line 8 and instead saw 'b'."
    )
...
exports["test 'yield' in compound expressions."] = function (test) {
  var code = fs.readFileSync(
    path.join(__dirname, "./fixtures/yield-expressions.js"),
    "utf8"
  );
...
exports["test 'yield' in invalid positions"] = function (test) {
  var testRun = TestRun(test, "as an invalid operand").addError(
    1,
    25,
    "Invalid position for 'yield' expression (consider wrapping in parenthesis)."
  );

  testRun.test("function* g() { null || yield; }", {
    esversion: 6,
    expr: true,
  });
  testRun.test("function* g() { null || yield null; }", {
    esversion: 6,
    expr: true,
  });
  testRun.test("function* g() { null || yield* g(); }", {
    esversion: 6,
    expr: true,
  });
  testRun.test("function* g() { null && yield; }", {
  ...
  testRun = TestRun(test, "as an invalid operand").addError(
    1,
    18,
    "Invalid position for 'yield' expression (consider wrapping in parenthesis)."
  );
  ...
  testRun.test("function* g() { 1 + yield null; }", {
    esversion: 6,
    expr: true,
  });
  testRun.test("function* g() { 1 + yield* g(); }", {
    esversion: 6,
    expr: true,
  });
  testRun.test("function* g() { 1 - yield; }", { esversion: 6, expr: true });
  ...
  testRun = TestRun(test, "with an invalid operand").addError(
    1,
    23,
    "Bad operand."
  );
  ...
  testRun.test("function* g() { yield ? null : null; }", {
    esversion: 6,
    expr: true,
  });
  ...
  testRun.test("function* g() { (yield ? 1 : 1); }", {
    esversion: 6,
    expr: true,
  });
  ...
  TestRun(test, "as a valid operand").test(
    [
      "function* g() {",
      "  (yield);",
      "  var x = yield;",
  ...
  TestRun(test, "with a valid operand").test(
    [
      "function *g() {",
      "  yield g;",
      "  yield{};",
  ...
  TestRun(test, "asi (ignoring warnings)").test(code, {
    esversion: 6,
    expr: true,
    asi: true,
  });
  ...
  TestRun(test, "name of a generator expression")
    ...
    .test(["(function * yield() {", "  yield;", "})();"], { esversion: 6 });
...
exports["test for line breaks with 'yield'"] = function (test) {
  ...
  var run = TestRun(test)
    .addError(
      3,
      5,
      "Expected ')' to match '(' from line 2 and instead saw 'c'."
    )
    .addError(3, 6, "Missing semicolon.")
  ...
  TestRun(test, "gh-2530 (asi: true)")
    .addError(
      5,
      3,
      "Misleading line break before 'fn'; readers may interpret this as an expression boundary."
    )
...
exports.ignoreDirective[
  "should be a good option and only accept start, end or line as values"
] = function (test) {
  var code = [
    "/*jshint ignore:start*/",
    "/*jshint ignore:end*/",
...
exports.ignoreDirective[
  "should allow the linter to skip blocked-out lines to continue finding errors in the rest of the code"
] = function (test) {
...
exports.ignoreDirective[
  "should ignore lines that appear to end with multiline comment endings (GH-1691)"
] = function (test) {
  var code = [
    "/*jshint ignore: start*/",
    "var a = {",
...
exports.ignoreDirective[
  "should ignore lines that end with a multi-line comment (GH-1396)"
] = function (test) {
  var code = [
    "/*jshint ignore:start */",
...
exports.ignoreDirective[
  "should be detected even with leading and/or trailing whitespace"
] = function (test) {
  var code = [
...
exports.ignoreDirective[
  "should apply to lines lexed during lookahead operations"
] = function (test) {
  var code = [
    "void [function () {",
    "  /* jshint ignore:start */",
...
exports[
  "should be able to ignore a single line with a trailing comment: // jshint:ignore"
] = function (test) {
...
exports["regression test for GH-1431"] = function (test) {
  ...
  TestRun(test)
    ...
    .addError(
      1,
      28,
      "Expected ')' to match '(' from line 1 and instead saw 'i'."
    )
...
exports[
  "jshint ignore:start/end should be detected using single line comments"
] = function (test) {
  var code = [
    "// jshint ignore:start",
    "var a;",
...
exports["regression crash from GH-1573"] = function (test) {
  TestRun(test)
    ...
    .addError(
      1,
      6,
      "Expected ']' to match '[' from line 1 and instead saw 'foo'."
    )
    .addError(1, 14, "Expected an identifier and instead saw ']'.")
    .addError(
      1,
...
exports["'for of' shouldn't be subject to 'for in' rules"] = function (test) {
  TestRun(test).test("for (let x of [1, 2, 3]) { console.log(x); }", {
    forin: true,
    esnext: true,
  });
  test.done();
...
exports[
  "enforcement of `forin` option should be tolerant of invalid syntax"
] = function (test) {
  TestRun(test)
    .addError(
      1,
    ...
    .addError(3, 1, "Expected an identifier and instead saw '}'.")
    .test(["for (x in x) {", "  if (", "}"], { forin: true });

  test.done();
};

exports[
  "Ignore strings containing braces within array literal declarations"
] = function (test) {
...
exports[
  "gh-1016: don't issue W088 if identifier is outside of blockscope"
] = function (test) {
  var code = [
    "var globalKey;",
    "function x() {",
  ...
  TestRun(test)
    .addError(
      17,
      10,
      "Creating global 'for' variable. Should be 'for (var nonKey ...'."
    )
    .test(code);
...
exports.testES6UnusedExports = function (test) {
  ...
  TestRun(test)
    .addError(
      24,
      5,
      "'letDefinedLater' was used before it was declared, which is illegal for 'let' variables."
    )
    .addError(
      25,
      7,
...
exports.testStrictDirectiveASI = function (test) {
  ...
  TestRun(test, 8)
    ...
    .test('(function() { var x; "use strict"; return x; }());', {
      strict: true,
      expr: true,
    });
  ...
  TestRun(test, 17).test('(() => { "use strict"; })();', {
    strict: true,
    esnext: true,
  });
...
exports.restOperatorWithoutIdentifier = function (test) {
  ...
  TestRun(test)
    ...
    .addError(
      7,
      22,
      "Expected an identifier and instead saw 'void' (a reserved word)."
    )
...
exports.getAsIdentifierProp = function (test) {
  ...
  TestRun(test).test("var get; var obj = { a: null, get, b: null };", {
    esnext: true,
  });

  TestRun(test).test("var get; var obj = { get, b: null };", { esnext: true });

  TestRun(test).test("var get; var obj = { get, get a() {} };", {
    esnext: true,
  });

  TestRun(test).test(
    ["var set;", "var obj = { set, get a() {}, set a(_) {} };"],
    { esnext: true }
  );
...
exports["new.target"] = function (test) {
  ...
  TestRun(test, "only in ES6")
    ...
    .addError(
      3,
      15,
      "'new.target' is only available in ES6 (use 'esversion: 6')."
    )
    .test(code);
...
exports.forInExpr = function (test) {
  ...
  TestRun(test)
    ...
    .test(["for (var x in [], []) {}", "for (var x of {}, {}) {}"], {
      esversion: 6,
    });
...
exports.unicode8 = function (test) {
  TestRun(test)
    .addError(
      1,
      5,
      "'unicode 8' is only available in ES6 (use 'esversion: 6')."
    )
...
exports.exponentiation.rightPrecedence = function (test) {
  TestRun(test, "ExponentiationExpression").test(
    [
      "x ** x ** y;",
      "x ** ++x ** y;",
      "x ** --x ** y;",
  ...
  TestRun(test, "UnaryExpression").test(
    [
      "x ** delete x.y;",
      "x ** void y;",
      "x ** typeof y;",
...
exports.letAsIdentifier = function (test) {
  ...
  TestRun(test, "identifier reference with ASI")
    ...
    .test(["let", "x;", "let", "void 0;", "let", "= 0;"], { esversion: 5 });
  ...
  TestRun(test, "identifier reference with ASI")
    ...
    .test(["let", "void 0;", "let", "= 0;"], { esversion: 6 });

  TestRun(test, "other uses").test([
    "let: while (false) {",
    "  break let;",
    "}",
    "void { let: 0 };",
...
exports.trailingParameterComma = function (test) {
  ...
  TestRun(test, "declaration in ES5")
    .addError(
      1,
      13,
      "'Trailing comma in function parameters' is only available in ES8 (use 'esversion: 8')."
    )
...
exports.trailingArgumentsComma = function (test) {
  ...
  TestRun(test, "valid - supported in ES8").test(["f(0,);", "f(0, 0,);"], {
    esversion: 8,
  });
...
exports.asyncFunctions.asyncIdentifier = function (test) {
  ...
  TestRun(test, "Line termination")
    ...
    .test(["async", "function f() {}", "async", "x => {};"], { esversion: 8 });
...
exports.asyncFunctions.expression = function (test) {
  ...
  TestRun(test, "Expression position").test("void async function() {};", {
    esversion: 8,
  });
...
exports.asyncFunctions.awaitOperator = function (test) {
  ...
  TestRun(test, "missing operands")
    ...
    .addError(2, 9, "Missing semicolon.")
    .test(["void async function() {", "  await;", "};"], { esversion: 8 });

  // Regression test for gh-3395
  TestRun(test, "within object initializer").test(
    [
      "void async function() {",
      "  void {",
      "    x: await 0,",
...
exports.asyncFunctions.objectMethod = function (test) {
  ...
  TestRun(test)
    ...
    .test(
      ["void {", "  async m() { await 0; },", "  n() { await 0; },", "};"],
      { esversion: 8 }
    );
...
exports.asyncFunctions.classMethod = function (test) {
  ...
  TestRun(test)
    ...
    .test(
      ["class C {", "  async m() { await 0; }", "  n() { await 0; }", "}"],
      { esversion: 8 }
    );
  ...
  TestRun(test, "Illegal line break")
    .addError(2, 3, "Line breaking error 'async'.")
    .test(["class C {", "  async", "  m() {}", "}"], { esversion: 8 });
...
exports.asyncGenerators.expression = function (test) {
  ...
  TestRun(test, "Expression position (disallowed prior to ES9)")
    .addError(
      1,
      6,
      "'async generators' is only available in ES9 (use 'esversion: 9')."
    )
  ...
  TestRun(test, "YieldExpression in parameter list")
    ...
    .test("void async function * (x = yield) { await 0; yield 0; };", {
      esversion: 9,
    });

  TestRun(test, "AwaitExpression in parameter list")
    .addError(1, 28, "Unexpected 'await'.")
    .test("void async function * (x = await 0) { await 0; yield 0; };", {
      esversion: 9,
    });
...
exports.asyncGenerators.declaration = function (test) {
  ...
  TestRun(test).test("async function * f() { await 0; yield 0; }", {
    esversion: 9,
  });
  ...
  TestRun(test, "YieldExpression in parameter list")
    ...
    .test("async function * f(x = yield) { await 0; yield 0; }", {
      esversion: 9,
    });

  TestRun(test, "AwaitExpression in parameter list")
    .addError(1, 24, "Unexpected 'await'.")
    .test("async function * f(x = await 0) { await 0; yield 0; }", {
      esversion: 9,
    });
...
exports.asyncGenerators.method = function (test) {
  ...
  TestRun(test).test("void { async * m() { await 0; yield 0; } };", {
    esversion: 9,
  });

  TestRun(test, "YieldExpression in parameter list")
    .addError(1, 22, "Unexpected 'yield'.")
    .test("void { async * m(x = yield) { await 0; yield 0; } };", {
      esversion: 9,
    });

  TestRun(test, "AwaitExpression in parameter list")
    .addError(1, 22, "Unexpected 'await'.")
    .test("void { async * m(x = await 0) { await 0; yield 0; } };", {
      esversion: 9,
    });
...
exports.asyncGenerators.classMethod = function (test) {
  ...
  TestRun(test).test("class C { async * m() { await 0; yield 0; } }", {
    esversion: 9,
  });

  TestRun(test, "YieldExpression in parameter list")
    .addError(1, 25, "Unexpected 'yield'.")
    .test("class C { async * m(x = yield) { await 0; yield 0; } }", {
      esversion: 9,
    });

  TestRun(test, "AwaitExpression in parameter list")
    .addError(1, 25, "Unexpected 'await'.")
    .test("class C { async * m(x = await 0) { await 0; yield 0; } }", {
      esversion: 9,
    });
  ...
  TestRun(test, "Illegal constructor")
    ...
    .addError(
      1,
      44,
      "Expected an identifier and instead saw 'yield' (a reserved word)."
    )
    .addError(
      1,
      44,
    ...
    .test("class C { async * constructor() { await 0; yield 0; } }", {
      esversion: 9,
    });
...
exports.asyncIteration = function (test) {
  TestRun(test, "unavailability in prior editions")
    .addError(
      2,
      7,
      "'asynchronous iteration' is only available in ES9 (use 'esversion: 9')."
    )
    .addError(
      3,
      7,
  ...
  TestRun(test, "typical usage").test(
    [
      "async function f() {",
      "  for await (var x of []) {}",
      "  for await (let x of []) {}",
  ...
  TestRun(test, "unavailability in synchronous contexts")
    ...
    .test(["function f() {", "  for await (var x of []) {}", "}"], {
      esversion: 9,
    });
  ...
  TestRun(test, "unavailability with for-in statements")
    ...
    .test(["async function f() {", "  for await (var x in []) {}", "}"], {
      esversion: 9,
    });
  ...
  TestRun(test, "unavailability with C-style for statements")
    ...
    .test(["async function f() {", "  for await (var x ; ;) {}", "}"], {
      esversion: 9,
    });
