...
exports.enabling = function (test) {
  ...
  TestRun(test, "Enabled via inline directive").test(
    ["// jshint.unstable bigint: true", "void 1n;"],
    { esversion: 9 }
  );

  TestRun(test, "Enabled via configuration object").test(["void 1n;"], {
    esversion: 9,
    unstable: { bigint: true },
  });
...
exports.validUsage = function (test) {
  ...
  TestRun(
    test,
    "No warnings for values that would otherwise coerce to Infinity"
  ).test(
    [
      "void " +
