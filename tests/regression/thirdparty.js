...
exports.prototype_1_7 = function (test) {
  ...
  TestRun(test)
    ...
    .addError(
      319,
      5,
      "Reassignment of 'isArray', which is a function. Use 'var' or 'let' to declare bindings that may change."
    )
    ...
    .addError(
      3827,
      5,
      "Reassignment of 'getOffsetParent', which is a function. Use 'var' or 'let' to declare bindings that may change."
    )
    .addError(
      3844,
      5,
      "Reassignment of 'positionedOffset', which is a function. Use 'var' or 'let' to declare bindings that may change."
    )
    .addError(
      3860,
      5,
      "Reassignment of 'cumulativeOffset', which is a function. Use 'var' or 'let' to declare bindings that may change."
    )
...
exports.lodash_0_6_1 = function (test) {
  ...
  TestRun(test)
    ...
    .addError(
      920,
      5,
      "Reassignment of 'isArguments', which is a function. Use 'var' or 'let' to declare bindings that may change."
    )
    .addError(
      963,
      5,
      "Reassignment of 'isFunction', which is a function. Use 'var' or 'let' to declare bindings that may change."
    )
